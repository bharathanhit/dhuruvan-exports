...
export const products = [
    ...
    },
    {
        ...
        description: 'High-grade traditional Indian pappad and far far snacks, processed in hygienic export-certified facilities.',
        badgeNote: 'Premium Quality',
        specifications: [
            { label: 'Base Ingredient', value: 'Urad Dal, Rice Flour, Tapioca or Potato Starch' },
            { label: 'Moisture content', value: '10% – 12% Maximum' },
            { label: 'Total Ash', value: 'Sub 1% Level' },
            { label: 'Shelf Life', value: '12 – 18 Months' },
            { label: 'Origin', value: 'Tamil Nadu / Gujarat, India' },
            { label: 'Grade', value: 'Premium Export Grade' },
            { label: 'Color & Appearance', value: 'Natural White / Multi-Color (Vegetable Based)' },
            { label: 'Texture', value: 'Uniformly Thin, High Crispiness Ratio' },
            { label: 'Packing Options', value: '200g, 500g Retail Pouches / 5kg, 10kg Bulk Cartons' },
            { label: 'Packaging Type', value: 'Food-Grade Moisture Proof Laminates' },
            { label: 'Fry Ratio', value: 'Expands 3-4x in volume' },
            { label: 'Unit of Measure', value: 'Kilograms (KG) / Metric Ton (MT)' },
            { label: 'Shipping', value: 'Sea Freight (FCL/LCL)' },
        ],
